...
const WARMUPS = {
  'chest-biceps': [
    ...
    },
    {
      ...
      description:
        'Place forearms on a doorframe at 90°. Step forward until you feel a stretch across the chest. Hold.',
      type: 'timed',
      duration: 30,
      equipment: [],
      cues: [
  ...
  back: [
    {
      name: 'Cat-Cow',
      description:
        'On hands and knees. Inhale — drop belly, lift head. Exhale — round spine, tuck chin. Slow and deliberate.',
      type: 'reps',
      reps: '10',
      equipment: [],
      cues: [
    ...
    },
    {
      ...
      description:
        'Stand tall. Hinge at the hips until you feel your hamstrings load, keeping your back flat. Squeeze glutes to stand.',
      type: 'reps',
      reps: '12',
      equipment: [],
      cues: [
    ...
    },
    {
      name: 'Scapular Pulls',
      description:
        'Hang from a bar with arms straight. Without bending your elbows, depress and retract your shoulder blades. Hold 1 sec at the top.',
      type: 'reps',
      reps: '8',
    ...
    },
    {
      name: 'Light Deadlift',
      description:
        'Movement rehearsal — brace your core, push the floor away, feel the lats engage before the bar leaves the ground.',
      type: 'reps',
      reps: '8',
      equipment: ['Barbell'],
      weightNote: 'Use ~20% of working weight',
  ...
  'ham-glutes': [
    ...
    },
    {
      name: 'Leg Swings',
      description:
        'Hold a wall for support. Swing each leg forward and back in a controlled arc, gradually increasing range.',
      type: 'reps',
      reps: '12 each leg',
      equipment: [],
      cues: [
    ...
    },
    {
      name: 'Glute Bridges',
      description:
        'Lie on your back, feet flat on the floor. Drive through your heels, squeeze glutes at the top. Hold for 1 second.',
      type: 'reps',
      reps: '15',
      equipment: [],
      cues: [
    ...
    },
    {
      name: 'Light RDL',
      description:
        'Feel the hamstrings load as you hinge. Push hips back, not down. This is about range and tension — not load.',
      type: 'reps',
      reps: '10',
      equipment: ['Barbell'],
      weightNote: 'Use ~20% of working weight',
  ...
  'shoulders-tri': [
    {
      name: 'Shoulder CARs',
      description:
        'Slow, controlled circular rotation of the shoulder through its full range. Keep the rest of your body completely still.',
      type: 'reps',
    ...
    },
    {
      name: 'Wall Slides',
      description:
        'Back flat against a wall, arms in a goalpost position. Slide arms overhead while keeping wrists, elbows and back in contact.',
      type: 'reps',
      reps: '10',
      equipment: [],
      cues: [
    ...
    },
    {
      ...
      description:
        'Hold a band at shoulder height with arms extended. Pull apart until it touches your chest, squeezing your shoulder blades together.',
      type: 'reps',
      reps: '15',
    ...
    },
    {
      ...
      description:
        'Press straight overhead, lock out at the top, lower slowly. Primes the rotator cuff before heavier work.',
      type: 'reps',
      reps: '12',
      equipment: ['Dumbbells'],
      weightNote: 'Use ~20% of working weight',
  ...
  quads: [
    {
      name: 'Hip Circles',
      description:
        'Stand on one leg, draw large circles with your opposite knee. Keeps the hip joint mobile before loading.',
      type: 'reps',
    ...
    },
    {
      name: 'Light Squat',
      description:
        'Same bar position and depth as your working sets. Lock in your stance and brace pattern before adding load.',
      type: 'reps',
      reps: '10',
  ...
  pull: [
    ...
    },
    {
      name: 'Hip Hinge Drill',
      description:
        'Stand tall. Hinge at the hips until you feel your hamstrings load, back flat. Squeeze glutes to stand.',
      type: 'reps',
      reps: '12',
      equipment: [],
      cues: [
    ...
    },
    {
      name: 'Light Deadlift',
      description:
        'Movement rehearsal — brace, push the floor away, feel the lats engage before the bar leaves the ground.',
      type: 'reps',
      reps: '8',
      equipment: ['Barbell'],
      weightNote: 'Use ~20% of working weight',
  ...
  legs: [
    {
      name: 'Hip Circles',
      description:
        'Stand on one leg, draw large circles with your opposite knee. Mobilises the hip joint before loading.',
      type: 'reps',
      reps: '10 each direction, each leg',
      equipment: [],
      cues: [
  ...
  'push-v2': [
    {
      name: 'Band Pull-Aparts',
      description:
        'Hold a band at shoulder height, arms straight. Pull it apart until it touches your chest, squeezing the shoulder blades.',
      type: 'reps',
      reps: '15',
      equipment: ['Resistance Bands'],
      cues: [
        'Arms stay straight — the movement comes from the shoulder blades',
        'Squeeze for a full second at the point the band touches your chest',
        "Return slowly — don't let the band snap you back",
      ],
    },
    {
      name: 'Light Bench Press',
      description: 'Same movement as your first working set. Focus on the bar path and the feel — not the load.',
      type: 'reps',
      reps: '15',
      equipment: ['Barbell', 'Flat Bench'],
      weightNote: 'Empty bar (20 kg) — that is the right warmup load for now',
      cues: [
        'Retract your shoulder blades before you unrack',
        'Feel the bar path — slight arc, not straight up',
        'Lower slowly — 2 seconds down',
  ...
  'pull-v2': [
    {
      ...
      cues: [
        'Move segment by segment — cervical, thoracic, lumbar',
        'Breath drives the movement: inhale = cow, exhale = cat',
        'Full range at each end — do not short-change it',
      ],
    },
    {
      ...
      weightNote: 'Add ~2 plates of assistance vs your working setting',
      cues: [
        'Lead with the elbows, not the hands',
        'Chest stays up — do not lean back to move the weight',
        'Feel the lats engage before the arms take over',
      ],
    },
  ],
  'legs-v2': [
    {
      ...
      equipment: [],
      cues: [
        'Keep your torso tall — do not fold forward as the leg rises',
        'Build the range gradually over the first few swings',
        'Control the leg at both ends — no flinging',
      ],
    },
    {
      name: 'Bodyweight Squats',
      description:
        'Full-depth squats at a steady pace. Grooves the pattern and gets blood into the quads and glutes before you load them.',
      type: 'reps',
      reps: '15',
      equipment: [],
      cues: [
        'Sit down between your hips rather than folding forward',
        'Knees track over your toes — let them travel forward',
        'Full depth on every rep, chest up throughout',
      ],
    },
    {
      name: 'Leg Press — Ramp Set 1',
      description: 'First ramp set. Light and easy — this is preparation for your working weight, not training.',
      type: 'reps',
      reps: '10',
      equipment: ['Leg Press Machine'],
      weightNote: '40 kg',
      cues: [
        'Groove the foot position you will use on your working sets',
        'Full range from the first rep — do not short it because it is light',
        'Nowhere near failure. This should feel easy',
      ],
    },
    {
      name: 'Leg Press — Ramp Set 2',
      description: 'Second ramp set. Bridges the gap to your working weight and primes the knees and hips for load.',
      type: 'reps',
      reps: '8',
      equipment: ['Leg Press Machine'],
      weightNote: '80 kg',
      cues: [
        'Same depth and foot position as the first ramp set',
        'Still short of failure — you have three working sets coming',
        'Check your lower back stays flat against the pad',
      ],
    },
  ],
};
